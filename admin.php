...
if ($userrow == false) { echo "Please log in to the <a href=\"../login.php?do=login\">game</a> before using the control panel."; }
if ($userrow["authlevel"] != 1) { echo "You must have administrator privileges to use the control panel."; }
